...
public class WookieeDatabase {
    ...
    public boolean sqlSell(String player, int itemid, int cost, int stack, String enchants, int durability) {
        ...
        try {
            ...
            ResultSet var1 = sqLite.query("SELECT * FROM wookieetrader WHERE player='" + player + "' AND itemid='" + itemid + "' AND durability='" + durability + "'  AND cost='" + cost + "' AND enchants='" + enchants + "'");
